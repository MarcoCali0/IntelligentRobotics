...
(cl:defmethod cl:initialize-instance :after ((m <Message>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Message)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exercise2-msg:<Message> is deprecated: use exercise2-msg:Message instead.")))

(cl:ensure-generic-function 'room_name-val :lambda-list '(m))
(cl:defmethod room_name-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise2-msg:room_name-val is deprecated.  Use exercise2-msg:room_name instead.")
  (room_name m))

(cl:ensure-generic-function 'room_ID-val :lambda-list '(m))
(cl:defmethod room_ID-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise2-msg:room_ID-val is deprecated.  Use exercise2-msg:room_ID instead.")
  (room_ID m))

(cl:ensure-generic-function 'charge_level-val :lambda-list '(m))
(cl:defmethod charge_level-val ((m <Message>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise2-msg:charge_level-val is deprecated.  Use exercise2-msg:charge_level instead.")
  (charge_level m))
