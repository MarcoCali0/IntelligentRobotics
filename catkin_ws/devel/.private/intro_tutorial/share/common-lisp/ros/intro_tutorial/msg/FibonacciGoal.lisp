...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name intro_tutorial-msg:<FibonacciGoal> is deprecated: use intro_tutorial-msg:FibonacciGoal instead.")))

(cl:ensure-generic-function 'order-val :lambda-list '(m))
(cl:defmethod order-val ((m <FibonacciGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader intro_tutorial-msg:order-val is deprecated.  Use intro_tutorial-msg:order instead.")
  (order m))
